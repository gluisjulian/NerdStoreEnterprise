...
namespace NSE.Identidade.API.Extensions
{
    public class IdentityMensagensPortugues : IdentityErrorDescriber
    {
        ...
        public override IdentityError InvalidUserName(string username) { return new IdentityError { Code = nameof(InvalidUserName), Description = $"O login {username} é inválido, pode conter apenas letras ou digitos." }; }
        ...
        public override IdentityError DuplicateUserName(string email) { return new IdentityError { Code = nameof(DuplicateUserName), Description = $"O email {email} já está sendo utilizado." }; }
        ...
        public override IdentityError PasswordRequiresUpper() { return new IdentityError { Code = nameof(PasswordRequiresUpper), Description = "As senhas devem conter ao menos umcaracter em caixa alta ('A' - 'Z')." }; }
    }
}
